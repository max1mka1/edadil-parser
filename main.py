    ...
    def parse_page(self, url):
        ...
        try:
            ...
            dict_of_info = {'description': description, 'categories': categories, 'retailer': retailer,
                            'dates': dates, 'new_price': new_price, 'old_price': old_price,
...
def main():
    ...
    for retailer_link in tqdm(retailers_links):
    ...
    database.to_csv('Edadil_database.csv', sep=',', encoding='cp1251')
    sleep(0.3)
